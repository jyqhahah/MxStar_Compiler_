...
forCondBlock.1:
    ...
    br i1 %slt.1, label %forBodyBlock.1, label %afterForBlock.1
...
forBodyBlock.1:
    ...
    br i1 %slt.2, label %thenBodyBlock.0, label %afterIfBlock.0
...
forCondBlock.0:
    %slt.0 = icmp slt i32 %i.8, %call.0
    br i1 %slt.0, label %forBodyBlock.0, label %afterForBlock.0

forBodyBlock.0:
    %element$.0 = getelementptr i32, i32* %arrayHead32.0, i32 %i.8
    %call.1 = call i32 @__getInt()
    store i32 %call.1, i32* %element$.0
    %prefixIncr.0 = add i32 %i.8, 1
    move %i.8, %prefixIncr.0
    br label %forCondBlock.0
...
forCondBlock.1:
    %slt.1 = icmp slt i32 %i.9, %call.0
    br i1 %slt.1, label %forBodyBlock.1, label %afterForBlock.1

forBodyBlock.1:
    %element$.1 = getelementptr i32, i32* %arrayHead32.0, i32 %i.9
    %element.1 = load i32, i32* %element$.1
    ...
    %prefixIncr.1 = add i32 %i.9, 1
    move %i.9, %prefixIncr.1
    br label %forCondBlock.1
